...
<!DOCTYPE html >
<html lang="en" style="background-color: #0c0b09;">
<head>
    <meta charset="UTF-8">
...
<body style="background-color: #0c0b09; color:white>
...
<div style="margin-left: 10%; margin-right: 10%;">
    ...
    <div class="row">
        <div class="col-12 col-lg-10 sombras offset-lg-1" style="padding: 5%; margin-bottom: 7%; background-color: #0c0b09; border-radius: 30px;">
        <br>
        ...
        <div class="row ">
            ...
            <div class="col-5 text-center">
                <h1 style="margin-top: 10px; color:white">El Pan Machin</h1>
            </div>
        </div>
        <br>
...
<script>
 ...
 <?php } ?>
        ...
        <h3 style="font-size: 18px;font-weight: 500;color: #fff; letter-spacing: .009em;line-height: 1.16667;">Nombre de Usuario</h3>
...
<h3 style="font-size: 18px;font-weight: 500;color: #fff; letter-spacing: .009em;line-height: 1.16667;">Número de Teléfono </h3>
...
<h3 style="font-size: 18px;font-weight: 500;color: #fff; letter-spacing: .009em;line-height: 1.16667;">Correo Electrónico</h3>
...
<h3 style="font-size: 18px;font-weight: 500;color: #fff; letter-spacing: .009em;line-height: 1.16667;">Contraseña</h3>
