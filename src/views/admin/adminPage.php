...
<head>
    ...
    <link rel="stylesheet" href="../../../assets/vendor/owl-carousel-2/owl.carousel.min.css">
    <link rel="stylesheet" href="../../../assets/vendor/owl-carousel-2/owl.theme.default.min.css">
...
<body>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="grilla">
                        <div class="card-1">Hola esta es una prueba1</div>
                        <div class="card-2">Hola esta es una prueba2</div>
                        <div class="card-3">Hola esta es una prueba3</div>
                        <div class="card-4">Hola esta es una prueba4</div>
                        <div class="card-5">Hola esta es una prueba5</div>
                    </div>
                </div>
    ...
    <script src="../../../assets/vendor/owl-carousel-2/owl.carousel.min.js"></script>
