...
<style>
        ...
        body{
            margin-top: 260px; /* Ajusta este valor al tamaño de tu navbar */
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <?php
       ...
       $db = new Database;
        ...
        // Crea la consulta SQL para obtener los datos del usuario
...
<form action="EditarUsuario.php" method="post">
    ...
    <div><h3>ID</h3><input class="form-control" type="text" name="id" value="<?php echo $id; ?>" readonly></div>
    <div><h3>Telefono</h3><input class="form-control" type="text" name="id" value="<?php echo isset($datos_usuarios['telefono']) ? $datos_usuarios['telefono'] : ''; ?>" readonly></div>
    <div><h3>Nombre</h3><input  class="form-control" type="text" name="nombre" value="<?php echo isset($datos_personas['nombre']) ? $datos_personas['nombre'] : ''; ?>" readonly> </div>
    <div><h3>Apellido</h3><input  class="form-control" type="text"  name="apellido" value="<?php echo isset($datos_personas['apellido']) ? $datos_personas['apellido'] : ''; ?>" readonly> </div>
    <div><h3>Correo</h3><input  class="form-control"type="text"  name="correo" value="<?php echo isset($datos_personas['correo']) ? $datos_personas['correo'] : ''; ?>" readonly> </div>
    <div><h3>Contraseña</h3><input class="form-control" type="password" id="contrasena" name="contrasena" value="<?php echo isset($datos_usuarios['contrasena']) ? $datos_usuarios['contrasena'] : ''; ?>" readonly> </div>
