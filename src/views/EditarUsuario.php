      ...
      <div class="row">
        <div class="col-lg-8">
          ...
          <form action="ProcesarEditar.php" method="post">
            ...
            <div>
              <h3>ID</h3><input class="form-control" id="input" type="text" name="id" value="<?php echo $id; ?>" readonly>
            </div>
            <div>
              <h3>Telefono</h3><input class="form-control" id="input" type="text" name="telefono" value="<?php echo $phone; ?>">
            </div>
            <div>
              <h3>Nombre</h3><input class="form-control" id="input" type="text" name="nombre" value="<?php echo $nombre_usuario; ?>">
            </div>
            <div>
              <h3>Apellido</h3><input class="form-control" id="input" type="text" name="apellido" value="<?php echo $apellido_persona; ?>">
            </div>
            <div>
              <h3>Correo</h3><input class="form-control" id="input" type="text" name="correo" value="<?php echo $correo_usuario; ?>">
            </div>
            <div>
              <h3>Contraseña</h3><input class="form-control" type="password" id="contrasena" name="contrasena" value="<?php echo $password; ?>">
            </div>
